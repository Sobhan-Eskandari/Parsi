            ...
            <nav class="navbar navbar-toggleable-md navbar-light fixed-top blogColor">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav mr-md-auto ml-md-auto mt-3 mt-md-0">
                        <li class="nav-item">
                            <a class="nav-link" href="/homePage">درباره همایش<span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/homePage">درباره رویداد</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/homePage">جوایز</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/homePage">سخنرانان</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/blogPng">بلاگ</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/homePage">حامیان</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/aboutUs">درباره ما</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/homePage">تماس با ما</a>
                        </li>
                    </ul>
